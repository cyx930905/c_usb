...
/* \brief key code 电脑键盘按键值 */
#define KEY_RESERVED            0                 /* 保留值 */
...
#define KEY_LEFTCTRL            29                /* 左边'CTRL'键 */
#define KEY_A                   30                /* 'A' */
#define KEY_S                   31                /* 'S' */
#define KEY_D                   32                /* 'D' */
#define KEY_F                   33                /* 'F' */
...
#define KEY_K                   37                /* 'K' */
#define KEY_L                   38                /* 'L' */
#define KEY_SEMICOLON           39                /* 分号';' */
#define KEY_APOSTROPHE          40                /* 上撇号''' */
#define KEY_GRAVE               41                /* '\' */
#define KEY_LEFTSHIFT           42                /* 左边shift键 */
...
#define KEY_DOT                 52                /* '.' */
#define KEY_SLASH               53                /* '/' */
#define KEY_RIGHTSHIFT          54                /* 右边shift键 */
#define KEY_KPASTERISK          55                /* 米字号 */
#define KEY_LEFTALT             56                /* 左边'Alt'键 */
#define KEY_SPACE               57                /* 空格 */
#define KEY_CAPSLOCK            58                /* 大小写字母转换键 "Caps Lock" */
#define KEY_F1                  59                /* 'F1' */
#define KEY_F2                  60                /* 'F2' */
#define KEY_F3                  61                /* 'F3' */
#define KEY_F4                  62                /* 'F4' */
...
#define KEY_F8                  66                /* 'F8' */
#define KEY_F9                  67                /* 'F9' */
#define KEY_F10                 68                /* 'F10' */
#define KEY_NUMLOCK             69                /* 'NUMLOCK' */
#define KEY_SCROLLLOCK          70                /* 'SCROLLLOCK' */
#define KEY_KP7                 71                /*  */
#define KEY_KP8                 72                /*  */
#define KEY_KP9                 73                /*  */
...
/* \brief 键盘报告输出数据*/
struct usbd_keyboard_in_report {
    uint8_t     ckey;              /* 键盘特定功能键，例如 ctrl，shift，at，win */
    uint8_t     cst;               /* 保留键，貌似没什么用 */
    uint8_t     key[6];            /* 普通按键，比如 ABCD，1234，F1，F2，最多支持同时按下6个普通按键 */
};

/* \bried 键盘报告输入数据*/
struct usbd_keyboard_out_report {
    uint8_t     led     :5;
    uint8_t     padding :3;
};
